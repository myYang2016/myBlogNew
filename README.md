...
yang:
    ...
    var ChangeNav = React.createClass({
        render:function(){
            return (
                <div>
                    <form action="/api/postNav" method="post" encType="multipart/form-data" target="_blank">
                    ...
                    <form action="/api/postNewBlog" method="post" encType="multipart/form-data" className="addBlog">
                        ...
                        <label>正文部分:</label><br/>
                        <textarea placeholder="input blog doc author" name="b_content" className="b_content" required="required" cols="50" rows="15" /><br />
                        <input type="submit" value='提交'/>
                    </form>
                </div>
            )
...
---
---
![hahahahha](http://i.imgur.com/FCO2O0g.png)
[https://www.baidu.com/?tn=90547864_hao_pg](https://www.baidu.com/?tn=90547864_hao_pg)  

This is [an example] [yang] reference-style link.  
This is [an example][id] reference-style link.  
[id]: http://example.com/  "Optional Title Here"
[yang]:http://baidu.com/ "hahahahhah"
[Google][]
